...
# Added: Sample size analysis, drill-down (Make/Age/Type + downloads), performance vs age/make insights
# New: Pareto Analysis Tab for Age, Failure %, Make, Volume, Type
import os
import time
import warnings
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('damper_analysis.log'),
...
def _get_creds_and_client():
    """Get Google credentials - works on both PC and Streamlit Cloud"""
    
    # Try Streamlit Cloud method first
    try:
    ...
    # Local PC method - hardcoded paths since you don't use .env
    credentials_path = "credentials.json"
    sheet_key = "1LUQhz49MVcnhnk3UuLleI_VYMgFNWV1YBVPbHlfdjpc"
